...
I certify that other than listed above, I have not collaborated with anyone on this assignment nor have I used any external resources to assist me in completing this assignment: Kavya Hosamane Jayanna
"""
...
def test_run():
    ...
    run_output = subprocess.run('/Users/kavyahj/Documents/project1-main/expr', stdout=subprocess.PIPE, stderr=subprocess.PIPE, encoding='utf-8')
